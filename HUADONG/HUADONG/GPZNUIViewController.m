...
#import "CellTabel.h"
@interface GPZNUIViewController ()<UIScrollViewDelegate,UITableViewDataSource,UITableViewDelegate>
///@brife 整个视图的大小
...
@end
@implementation GPZNUIViewController
-(void)viewDidLoad{
    [self initTopView:@"购票指南"];
    self.namearray = [[NSArray alloc]initWithObjects:@"售票窗口",@"购票须知", nil];
...
-(void) initTopTabs:(NSArray *)namearray{
    ...
    UIView *view = [[UIView alloc] initWithFrame:CGRectMake(0, 0, _mViewFrame.size.width, 30)];
...
-(void)scrollViewDidEndDecelerating:(UIScrollView *)scrollView{
    ...
    if ((numbertable + 1) > self.tablearray.count) {
        ...
        tableview = self.tablearray[numbertable - 1];
    }
